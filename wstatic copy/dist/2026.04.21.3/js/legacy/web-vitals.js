    ...
    var t,
        ...
        C = function (e) {
            "hidden" === document.visibilityState &&
                S > -1 &&
                ((S = "visibilitychange" === e.type ? e.timeStamp : 0), L());
        },
        b = function () {
                            ...
                            e.forEach(function (e) {
                                "first-contentful-paint" === e.name &&
                                    ...
                                    e.startTime < r.firstHiddenTime &&
                                        ((i.value = Math.max(e.startTime - m(), 0)), i.entries.push(e), n(!0)));
                            });
                        });
                    a &&
        ...
        x = new Date(),
        B = function (e, i) {
            t || ((t = i), (n = e), (r = new Date()), N(removeEventListener), D());
        },
        D = function () {
            if (n >= 0 && n < r - x) {
                var e = {
                    ...
                    var a,
                        ...
                        c = function (e) {
                            e.startTime < o.firstHiddenTime &&
                                ((u.value = e.processingStart - e.startTime), u.entries.push(e), a(!0));
                        },
                        s = function (e) {
                            e.forEach(c);
                        },
                        f = p("first-input", s);
                    (a = h(e, u, R, r.reportAllChanges)),
                        f &&
                            T(
                                y(function () {
        ...
        U = function () {
            "interactionCount" in performance ||
                a ||
                (a = p("event", j, { type: "event", buffered: !0, durationThreshold: 0 }));
        },
        z = [200, 500],
        G = 0,
        J = function () {
            ...
            (t = t || {}),
                F(function () {
                    ...
                    var n,
                        ...
                        i = function (e) {
                            e.forEach(function (e) {
                                (e.interactionId && W(e), "first-input" === e.entryType) &&
                                    !K.some(function (t) {
                    ...
                    (n = h(e, r, z, t.reportAllChanges)),
                        a &&
                            ...
                            l(function () {
                                (K = []), (G = V()), (r = v("INP")), (n = h(e, r, z, t.reportAllChanges));
                            }));
                });
        },
        Y = [2500, 4e3],
        ...
        (e.onFCP = function (e, t) {
            P(function (t) {
                !(function (e) {
                    ...
                    e.attribution = { timeToFirstByte: 0, firstByteToFCP: e.value, loadState: u(d()) };
                })(t),
                    e(t);
            }, t);
        }),
                        ...
                        var n,
                            ...
                            a = function (e) {
                                ...
                                t &&
                                    ...
                                    ((i.value = Math.max(t.startTime - m(), 0)), (i.entries = [t]), n());
                            },
