...
function getAnonymousUserToken() {
    return getCookieValue("ajs_anonymous_id");
}
...
!(function (t, e) {
    ...
    function c(t, e, r) {
        var n = {
            ...
            "x-algolia-usertoken": getAnonymousUserToken(),
        };
        return {
            headers: function () {
    ...
    function S(t, e, n, a) {
        var i = [],
            ...
            d = r(r(r({ "x-algolia-agent": t.userAgent.value }, t.queryParameters), f), a.queryParameters),
            l = 0,
            p = function e(r, o) {
                var f = r.pop();
                if (void 0 === f)
    ...
    var C = function (t) {
            return function (e, r) {
                return t.transporter.write({ method: j, path: "2/abtests", data: e }, r);
            };
        },
        U = function (t) {
            return function (e, r) {
        ...
        F = function (t) {
            return function (e, r) {
                return t.transporter.write({ method: j, path: h("2/abtests/%s/stop", e) }, r);
            };
        },
        H = function (t) {
            return function (e) {
        ...
        M = function (t) {
            return function (e, r) {
                return t.transporter.write({ method: j, path: "1/strategies/personalization", data: e }, r);
            };
        };
    function K(t) {
        return (function e(r) {
    ...
    var W = function (t) {
            return function (e, a) {
                ...
                return d(t.transporter.write({ method: j, path: "1/keys", data: s }, u), function (e, r) {
                    return f(function (n) {
        ...
        B = function (t) {
            return function (e, r, n) {
                ...
                return (
                    ...
                    t.transporter.write({ method: j, path: "1/clusters/mapping", data: { cluster: r } }, a)
                );
            };
        },
        Q = function (t) {
            return function (e, r, n) {
                return t.transporter.write(
                    { method: j, path: "1/clusters/mapping/batch", data: { users: e, cluster: r } },
                    n,
                );
            };
        },
        ...
        L = function (t) {
            return function (e, r, n) {
                return d(
                    ...
                    function (r, n) {
                        return ut(t)(e, { methods: { waitTask: de } }).waitTask(r.taskID, n);
                    },
                );
            };
        },
        ...
        Z = function (t) {
            return function (e, r) {
                return d(t.transporter.write({ method: I, path: h("1/keys/%s", e) }, r), function (r, n) {
                    return f(function (r) {
                        return tt(t)(e, n)
                            .then(r)
                            .catch(function (t) {
        ...
        et = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: x, path: h("1/task/%s", e.toString()) }, r);
            };
        },
        rt = function (t) {
            return function (e) {
                return t.transporter.read({ method: x, path: "/1/dictionaries/*/settings" }, e);
            };
        },
        nt = function (t) {
            return function (e) {
        ...
        ot = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: x, path: h("1/clusters/mapping/%s", e) }, r);
            };
        },
        it = function (t) {
            return function (e) {
                ...
                return (
                    !0 === a && (o.getClusters = !0),
                    t.transporter.read({ method: x, path: "1/clusters/mapping/pending" }, o)
                );
            };
        },
        ut = function (t) {
        ...
        pt = function (t) {
            return function (e, r) {
                return d(
                    t.transporter.write({ method: j, path: "1/indexes/*/batch", data: { requests: e } }, r),
                    function (e, r) {
                        return Promise.all(
                            Object.keys(e.taskID).map(function (n) {
                                return ut(t)(n, { methods: { waitTask: de } }).waitTask(e.taskID[n], r);
                            }),
                        );
                    },
                );
        ...
        ht = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: j, path: "1/indexes/*/objects", data: { requests: e } }, r);
            };
        },
        mt = function (t) {
            return function (e, n) {
                ...
                return t.transporter.read(
                    { method: j, path: "1/indexes/*/queries", data: { requests: a }, cacheable: !0 },
                    n,
                );
            };
        },
            ...
            return function (e, a) {
                return Promise.all(
                    e.map(function (e) {
                        ...
                        return ut(t)(e.indexName, { methods: { searchForFacetValues: ue } }).searchForFacetValues(
                            i,
                            u,
                            r(r({}, a), s),
                        );
        ...
        bt = function (t) {
            return function (e, r) {
                return d(t.transporter.write({ method: j, path: h("1/keys/%s/restore", e) }, r), function (r, n) {
                    return f(function (r) {
        ...
        wt = function (t) {
            return function (e, r, n) {
                return t.transporter.read(
                    { method: j, path: h("/1/dictionaries/%s/search", e), data: { query: r }, cacheable: !0 },
                    n,
                );
            };
        },
        Ot = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: j, path: "1/clusters/mapping/search", data: { query: e } }, r);
            };
        },
        It = function (t) {
            return function (e, r) {
                return d(
                    t.transporter.write({ method: D, path: "/1/dictionaries/*/settings", data: e }, r),
                    function (e, r) {
                        return jt(t)(e.taskID, r);
                    },
                );
        ...
        xt = function (t) {
            return function (e, r) {
                ...
                return d(t.transporter.write({ method: D, path: h("1/keys/%s", e), data: s }, u), function (r, n) {
                    return f(function (r) {
        ...
        Dt = function (t) {
            return function (e, r) {
                return d(
                    t.transporter.write(
                        { method: j, path: h("1/indexes/%s/batch", t.indexName), data: { requests: e } },
                        r,
                    ),
                    function (e, r) {
                ...
                return K(
                    r(
                        ...
                        {},
                        {
                            request: function (r) {
                                return t.transporter.read(
                                    { method: j, path: h("1/indexes/%s/browse", t.indexName), data: r },
                                    e,
                                );
                            },
                        },
        ...
        Nt = function (t) {
            return function (e) {
                return d(
                    t.transporter.write({ method: j, path: h("1/indexes/%s/clear", t.indexName) }, e),
                    function (e, r) {
                        return de(t)(e.taskID, r);
                    },
                );
        ...
        Et = function (t) {
            return function (e) {
                ...
                return (
                    ...
                    d(
                        t.transporter.write({ method: j, path: h("1/indexes/%s/rules/clear", t.indexName) }, o),
                        function (e, r) {
                            return de(t)(e.taskID, r);
                        },
                    )
        ...
        Rt = function (t) {
            return function (e) {
                ...
                return (
                    a && (o.queryParameters.forwardToReplicas = 1),
                    d(
                        t.transporter.write({ method: j, path: h("1/indexes/%s/synonyms/clear", t.indexName) }, o),
                        function (e, r) {
                            return de(t)(e.taskID, r);
                        },
                    )
        ...
        At = function (t) {
            return function (e, r) {
                return d(
                    t.transporter.write({ method: j, path: h("1/indexes/%s/deleteByQuery", t.indexName), data: e }, r),
                    function (e, r) {
                        return de(t)(e.taskID, r);
                    },
                );
        ...
        Ct = function (t) {
            return function (e) {
                return d(t.transporter.write({ method: I, path: h("1/indexes/%s", t.indexName) }, e), function (e, r) {
                    return de(t)(e.taskID, r);
                });
            };
        },
        ...
        Jt = function (t) {
            return function (e, r) {
                ...
                return (
                    ...
                    d(
                        t.transporter.write({ method: I, path: h("1/indexes/%s/rules/%s", t.indexName, e) }, i),
                        function (e, r) {
                            return de(t)(e.taskID, r);
                        },
                    )
        ...
        Ft = function (t) {
            return function (e, r) {
                ...
                return (
                    o && (i.queryParameters.forwardToReplicas = 1),
                    d(
                        t.transporter.write({ method: I, path: h("1/indexes/%s/synonyms/%s", t.indexName, e) }, i),
                        function (e, r) {
                            return de(t)(e.taskID, r);
                        },
                    )
        ...
        Kt = function (t) {
            return function (e, o) {
                var i = o || {},
                    ...
                    f = 0;
                return (function n() {
                    return ie(t)(u || "", r(r({}, c), {}, { page: f })).then(function (t) {
                        for (var r = 0, o = Object.entries(t.hits); r < o.length; r++) {
                            var i = a(o[r], 2),
                                u = i[0],
                                c = i[1];
                            if (e(c)) return { object: c, position: parseInt(u, 10), page: f };
                        }
        ...
        Wt = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: x, path: h("1/indexes/%s/%s", t.indexName, e) }, r);
            };
        },
        Bt = function () {
            return function (t, e) {
        ...
        Qt = function (t) {
            return function (e, a) {
                var o = a || {},
                    ...
                    s = e.map(function (e) {
                        return r({ indexName: t.indexName, objectID: e }, i ? { attributesToRetrieve: i } : {});
                    });
                return t.transporter.read({ method: j, path: "1/indexes/*/objects", data: { requests: s } }, u);
            };
        },
        Gt = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: x, path: h("1/indexes/%s/rules/%s", t.indexName, e) }, r);
            };
        },
        Lt = function (t) {
            return function (e) {
                return t.transporter.read(
                    { method: x, path: h("1/indexes/%s/settings", t.indexName), data: { getVersion: 2 } },
                    e,
                );
            };
        },
        Vt = function (t) {
            return function (e, r) {
                return t.transporter.read({ method: x, path: h("1/indexes/%s/synonyms/%s", t.indexName, e) }, r);
            };
        },
        _t = function (t) {
            return function (e, r) {
        ...
        Yt = function (t) {
            return function (e, i) {
                var u = i || {},
                    ...
                    v = [],
                    b = p(t.indexName, y, "copy", r(r({}, l), {}, { scope: ["settings", "synonyms", "rules"] }));
                return (
                    v.push(b),
                    d(
                        (s ? b.wait(l) : b)
                            .then(function () {
                                var t = g(e, r(r({}, l), {}, { autoGenerateObjectIDIfNotExist: c, batchSize: f }));
                            ...
                            .then(function (t) {
                                var e = a(t, 3),
                                    ...
                                    n = e[1],
                                    i = e[2];
                                return { objectIDs: n.objectIDs, taskIDs: [r.taskID].concat(o(n.taskIDs), [i.taskID]) };
                            }),
                        function (t, e) {
                            return Promise.all(
                                v.map(function (t) {
        ...
        ne = function (t) {
            return function (e, r) {
                ...
                return (
                    ...
                    d(
                        t.transporter.write(
                            { method: j, path: h("1/indexes/%s/rules/batch", t.indexName), data: e },
                            u,
                        ),
                        function (e, r) {
                            return de(t)(e.taskID, r);
        ...
        oe = function (t) {
            return function (e, r) {
                ...
                return (
                    ...
                    d(
                        t.transporter.write(
                            { method: j, path: h("1/indexes/%s/synonyms/batch", t.indexName), data: e },
                            s,
                        ),
                        function (e, r) {
                            return de(t)(e.taskID, r);
        ...
        ie = function (t) {
            return function (e, r) {
                return t.transporter.read(
                    { method: j, path: h("1/indexes/%s/query", t.indexName), data: { query: e }, cacheable: !0 },
                    r,
                );
            };
        },
        ...
        se = function (t) {
            return function (e, r) {
                return t.transporter.read(
                    { method: j, path: h("1/indexes/%s/rules/search", t.indexName), data: { query: e } },
                    r,
                );
            };
        },
        ce = function (t) {
            return function (e, r) {
                return t.transporter.read(
                    { method: j, path: h("1/indexes/%s/synonyms/search", t.indexName), data: { query: e } },
                    r,
                );
            };
        },
        fe = function (t) {
            return function (e, r) {
                ...
                return (
                    o && (i.queryParameters.forwardToReplicas = 1),
                    d(
                        t.transporter.write({ method: D, path: h("1/indexes/%s/settings", t.indexName), data: e }, i),
                        function (e, r) {
                            return de(t)(e.taskID, r);
                        },
                    )
            ...
            return function (e, r) {
                return f(function (n) {
                    return (function (t) {
                        return function (e, r) {
                            return t.transporter.read(
                                { method: x, path: h("1/indexes/%s/task/%s", t.indexName, e.toString()) },
                                r,
                            );
                        };
    ...
    function ge(t, e, n) {
        var a,
            o = {
                        ...
                        return new Promise(function (e) {
                            ...
                            (r.onreadystatechange = function () {
                                r.readyState > r.OPENED &&
                                    void 0 === n &&
                                    (clearTimeout(o), (n = a(t.responseTimeout, "Socket timeout")));
                            }),
                                (r.onerror = function () {
                                    0 === r.status &&
                                        (clearTimeout(o),
                                ...
                                (r.onload = function () {
                                    clearTimeout(o),
                                        clearTimeout(n),
                                        e({ content: r.responseText, status: r.status, isTimedOut: !1 });
                                }),
                                r.send(t.data);
                        });
                    },
                ...
                hostsCache: u({ caches: [i({ key: "".concat("4.14.2", "-").concat(t) }), s()] }),
                ...
                return function (t) {
                    return (function (t) {
                        var e = t.region || "us",
                            ...
                            a = k(
                                r(
                                    r({ hosts: [{ url: "personalization.".concat(e, ".algolia.com") }] }, t),
                                    {},
                                    {
                                        headers: r(
                                            r(r({}, n.headers()), { "content-type": "application/json" }),
                                            t.headers,
                                        ),
                        ...
                        r(
                            r(r({}, o), t),
                            {},
                            { methods: { getPersonalizationStrategy: H, setPersonalizationStrategy: M } },
                        ),
                    );
                };
            };
            ...
            var e = t.appId,
                ...
                a = k(
                    r(
                        ...
                        {
                            headers: r(
                                r(r({}, n.headers()), { "content-type": "application/x-www-form-urlencoded" }),
                                t.headers,
                            ),
                            queryParameters: r(r({}, n.queryParameters()), t.queryParameters),
                        },
