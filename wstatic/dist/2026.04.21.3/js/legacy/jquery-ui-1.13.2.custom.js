 ...
 * http://jqueryui.com
 * Includes: widget.js, position.js, disable-selection.js, focusable.js, jquery-patch.js, keycode.js, scroll-parent.js, tabbable.js, unique-id.js, widgets/autocomplete.js, widgets/menu.js
...
(function (factory) {
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        _create: function () {
            ...
            this._addClass("ui-menu", "ui-widget ui-widget-content ui-corner-all");
            this._on({
        ...
        refresh: function () {
            ...
            this._addClass(newSubmenus, "ui-menu", "ui-widget ui-widget-content ui-front ui-corner-all");
            ...
            newWrappers = newItems.children().not(".ui-menu, .header").uniqueId().attr({
                tabIndex: -1,
                role: this._itemRole(),
            });
            this._addClass(newWrappers.parent(), "ui-menu-item");
            this._addClass(newWrappers, "ui-menu-item-wrapper ui-corner-all");
