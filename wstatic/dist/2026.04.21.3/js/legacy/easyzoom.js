...
(function ($, undefined) {
    function EasyZoom(target, options) {
        ...
        var defaults = {
            id: "zoom-panel",
            parent: "body",
            error: '<p class="zoom-error">There has been a problem attempting to load the image.</p>',
        ...
        function init() {
            ...
            if (self.opts.touch && "ontouchstart" in document.documentElement) {
                target.addEventListener(
                    "touchstart",
                    function (e) {
                        if (isNumeric(e.touches.length) && e.touches.length > 1) {
                            e.preventDefault();
        ...
        function show(e) {
            ...
            self.ele.$panel.stop().animate({ opacity: 1 }, 200);
        ...
        this.hide = function () {
            if (self.ele.$panel.parent().length) {
                self.ele.$panel.stop().animate({ opacity: 0 }, 200, function () {
